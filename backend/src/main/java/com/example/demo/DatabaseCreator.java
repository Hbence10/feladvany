...
public class DatabaseCreator {
    ...
    public void createDatabase() {
        ...
        for (String i : pIdList.keySet()) {
            ...
            if (isNew) {
                Integer grossPrice = !pIdList.get(i).get(1).equals("") ? Integer.valueOf(pIdList.get(i).get(1).replaceAll(" ", "")) : null;
                Integer stockQuantity = !pIdList.get(i).get(2).equals("") ? Integer.valueOf(pIdList.get(i).get(1).replaceAll(" ", "")) : null;
